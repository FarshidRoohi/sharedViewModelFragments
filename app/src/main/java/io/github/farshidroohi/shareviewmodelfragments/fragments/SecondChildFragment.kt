...
import io.github.farshidroohi.shareviewmodelfragments.databinding.FragmentSecondChildBinding
...
class SecondChildFragment : Fragment() {
    ...
    private var _binding: FragmentSecondChildBinding? = null
    private val binding: FragmentSecondChildBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSecondChildBinding.inflate(inflater, container, false)
